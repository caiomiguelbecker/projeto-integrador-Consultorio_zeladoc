...
class Convenio_View:
    def __init__(self, master):
        ...
        self.janela.title(t("menu_convenios"))
        self.janela.geometry("400x220")

        ttk.Label(self.janela, text=t("cadastro_convenio"), font=("Arial", 14, "bold")).pack(pady=10)
    ...
    def salvar(self):
        ...
        print(f"[TODO: ligar ao controller] Salvar convênio: {nome}")